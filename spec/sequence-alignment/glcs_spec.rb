...
describe GLCS do
  ...
  context 'in the beginning of a string' do
    it 'should detect a deletion' do
      ...
      expect(glcs.common_elements).to eq([['a', 'a'], ['b', 'b'], ['c', 'c']])
      expect(glcs.mapped_elements).to eq([])
      expect(glcs.front_overflow).to eq 3
      expect(glcs.rear_overflow).to eq 0
    end
    ...
    it 'should detect a variation' do
      ...
      expect(glcs.common_elements).to eq([['a', 'a'], ['b', 'b'], ['c', 'c']])
      expect(glcs.mapped_elements).to eq([['ijk', 'xy']])
      expect(glcs.front_overflow).to eq 1
      expect(glcs.rear_overflow).to eq 0
    end
  end
  ...
  context 'in the end of a string' do
    it 'should detect a deletion' do
      ...
      expect(glcs.common_elements).to eq([['a', 'a'], ['b', 'b'], ['c', 'c']])
      expect(glcs.mapped_elements).to eq([])
      expect(glcs.front_overflow).to eq 0
      expect(glcs.rear_overflow).to eq 3
    end
    ...
    it 'should detect a variation' do
      ...
      expect(glcs.mapped_elements).to eq([['ijk', 'xy']])
      expect(glcs.front_overflow).to eq 0
      expect(glcs.rear_overflow).to eq 1
    end
  end
  ...
  context 'in the middle of a string' do
    it 'should detect a deletion' do
      ...
      expect(glcs.common_elements).to eq([['a', 'a'], ['b', 'b'], ['c', 'c'], ['d', 'd']])
      expect(glcs.mapped_elements).to eq([])
      expect(glcs.front_overflow).to eq 0
      expect(glcs.rear_overflow).to eq 0
    end
  ...
  context ', with a dictionary with the first entry, ' do
    ...
    it 'should handle consecutive unicode spellouts in the middle of a string' do
      ...
      expect(glcs.common_elements).to eq([['-', '-'], ['β', 'beta'], ['-', '-']])
      expect(glcs.mapped_elements).to eq([['κ', 'kappa']])
      expect(glcs.front_overflow).to eq 0
      expect(glcs.rear_overflow).to eq 0
    end
    ...
    it 'should handle consecutive unicode spellouts in the end of a string' do
      ...
      expect(glcs.mapped_elements).to eq([['κ', 'kappa']])
      expect(glcs.front_overflow).to eq 0
      expect(glcs.rear_overflow).to eq -4
    end
    ...
    it 'should handle consecutive unicode restorations in the middle of a string' do
      ...
      expect(glcs.common_elements).to eq([['-', '-'], ['beta', 'β'], ['-', '-']])
      expect(glcs.mapped_elements).to eq([['kappa', 'κ']])
    end
