...
describe TextAlignment do
  context 'for exception handling' do
    it 'should raise error for passing of nil strings' do
      expect {TextAlignment.new('abc', nil)}.to raise_error
      expect {TextAlignment.new(nil, 'abc')}.to raise_error
      expect {TextAlignment.new(nil, nil)}.to raise_error
    end

    it 'should raise error for passing of nil dictionary' do
      expect {TextAlignment.new('abc', 'abc', nil)}.to raise_error
    end
  end
  ...
  context 'in the beginning of a string' do
    it 'should detect a deletion' do
                      #012345    012
      sa = TextAlignment.new('xyzabc', 'abc')
    ...
    it 'should detect an addition' do
                      #012    012345
      sa = TextAlignment.new('abc', 'xyzabc')
    ...
    it 'should detect a variation' do
                      #012345    01234
      sa = TextAlignment.new('ijkabc', 'xyabc')
  ...
  context 'in the end of a string' do
    it 'should detect a deletion' do
                      #012345    012
      sa = TextAlignment.new('abcxyz', 'abc')
    ...
    it 'should detect an addition' do
                      #012    012345
      sa = TextAlignment.new('abc', 'abcxyz')
    ...
    it 'should detect a variation' do
                      #012345    01234
      sa = TextAlignment.new('abcijk', 'abcxy')
  ...
  context 'in the middle of a string' do
    it 'should detect a deletion' do
                      #0123456    0123
      sa = TextAlignment.new('abxyzcd', 'abcd')
    ...
    it 'should detect an addition' do
                      #0123    0123456
      sa = TextAlignment.new('abcd', 'abxyzcd')
    ...
    it 'should detect a variation' do
                      #0123456    012345
      sa = TextAlignment.new('abijkcd', 'abxycd')
  ...
  context ', with a dictionary with the first entry, ' do
    ...
    it 'should handle consecutive unicode spellouts in the middle of a string' do
                      #0123    01234567890
      sa = TextAlignment.new('-βκ-', '-betakappa-', @dictionary)
    ...
    it 'should handle consecutive unicode restorations in the middle of a string' do
                      #01234567890    0123
      sa = TextAlignment.new('-betakappa-', '-βκ-', @dictionary)
  ...
  context ', with a dictionary, ' do
    ...
    it 'should handle a unicode spellout followed by addition' do
                      #012    012345678
      sa = TextAlignment.new("-β-", "-beta***-", @dictionary)
    ...
    it 'should handle a unicode retoration followed by addition' do
                      #012345    012345
      sa = TextAlignment.new("-beta-", "-β***-", @dictionary)
